...
class MainScreen_operator(MainScreen):  # singleton 
    ...
    def __init__(self):
        if MainScreen_operator.__instance != None:
            ...
            self.__title = Label(MainScreen._ms_header_frame, text = "OPERADOR", bg = constants.CATSALUT_COLOR, font = (constants.CATSALUT_TEXT_FONT, constants.SCREEN_TITLE_TEXT_SIZE, 'bold'))
    ...
    def __refill_kits(self):  
        ...
        DBcontroller.add_new_event( ActivePerson.getCurrent().get_CIP(), "OPERADOR REPUSO KITS")
    ...
    def __collect_samples(self):
        ...
        DBcontroller.add_new_event( ActivePerson.getCurrent().get_CIP(), "OPERADOR RECOGIO MUESTRAS")
    ...
    def __refill_labels(self):
        ...
        DBcontroller.add_new_event( ActivePerson.getCurrent().get_CIP(), "OPERADOR REPUSO ETIQUETAS")
