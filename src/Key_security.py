...
class Key_security:
    ...
    def __init__(self):
        ...
        Button(self.__key_window, text="   0   ", font = (constants.CATSALUT_TEXT_FONT, constants.BUTTON_TEXT_SIZE), command=lambda: self.__button_click(0)).grid(row = 5, column = 1, sticky = 'NSEW')  # note that the charachter to display is not "0" but "0     ". This is to make this column as wide as the other columns
