...
#    "comprobacion vaciado deposito muestras (cabecera)" : 73,  # Finally dont use (an operator is always able to collect samples (doesn't need extra resources), this is why we don't show a message saying "were you able to empty the samples container?")
