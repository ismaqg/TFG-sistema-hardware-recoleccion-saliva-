...
str_to_index_map = {
    ...
    "reposicion finalizada (cuerpo)" : 32,
    ...
    "necesaria reposicion kit (cabecera)" : 67,
    "necesaria reposicion kits (cuerpo)" : 68,
    "comprobacion reposicion kits (cabecera)" : 69,
    "comprobacion reposicion kits (cuerpo)" : 70, 
    "necesario vaciado muestras (cabecera)" : 71,
    "necesario vaciado muestras (cuerpo)" : 72,
    "comprobacion vaciado deposito (cabecera)" : 73,
    "comprobacion vaciado deposito (cuerpo)" : 74,
